...
class TerrainSettings2_v1_39_0_RU(CStructure):
    _size_ = 132
...
class BWT2_Section_1_39_0_RU(Base_JSON_Section):
    header = 'BWT2'
    int1 = 3
    ...
    _fields_ = [
        ...
        (list, '3',             '<i'                         ),
        (dict, 'settings2',     TerrainSettings2_v1_39_0_RU  ),
    ...
    def prepare_unp_xml(*args):
        return BWT2_Section_1_6_1.prepare_unp_xml(*args)

    @staticmethod
    def flush_unp_xml(chunks):
        return BWT2_Section_1_6_1.flush_unp_xml(chunks)
