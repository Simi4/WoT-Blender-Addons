...
class MaterialInfo_1_37_0_RU(CStructure):
	_size_ = 20
...
class BSMA_Section_1_37_0_RU(Base_JSON_Section):
	header = 'BSMA'
	int1 = 1
	...
	def from_bin_stream(self, stream, row):
		self._data = {}
		self._data['materials'] = self.read_entries(stream, MaterialInfo_1_37_0_RU)
	...
	def to_bin(self):
		res = self.write_entries(self._data['materials'], MaterialInfo_1_37_0_RU)
